...
function HomePage() {
  ...
  const AddTask = () => {
    if (!TaskTitle || !Completed || !TaskDes || !Priorty) {
      SetValidate(true);
      setTimeout(() => {
        SetValidate(false);
      }, 10000);
        ...
        <Container maxWidth="lg" sx={{
          ...
          <Box sx={{
            width: {
              md: '50%',
              xs: "100%"
            }, mt: 6, display: 'flex', justifyContent: 'start', alignItems: 'center', flexDirection: 'column', px: 2
          }} >
            <Box sx={{ width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }} >
              ...
              <Box sx={{ width: '100%', height: '40px', display: 'flex', justifyContent: 'center', alignItems: 'center', borderRadius: '20px', border: '1px solid #666666', px: 1 }} >
                <Box sx={{
                  height: '100%', width: {
                    sm: '5%',
                    xs: '10%'
                ...
                <Box sx={{ width: '92%', display: 'flex', justifyContent: 'center', alignItems: 'center' }} >
                  <input value={TaskTitle} onChange={(e) => setTaskTitle(e.target.value)} type="email" style={{ width: '100%', height: '100%', outline: 'none', border: 'unset', fontSize: '16px', lineHeight: '24px', padding: '0px 4px', color: '#666666' }} placeholder='Enter task title here...' />
                </Box>
              </Box>
              <Box sx={{ width: '100%', display: 'flex', justifyContent: 'start', alignItems: 'center' }} >
            ...
            <Box sx={{ width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', mt: 3 }} >
              ...
              <Box sx={{ width: '100%', height: '40px', display: 'flex', justifyContent: 'center', alignItems: 'center' }} >
                <FormControl sx={{ borderRadius: '20px', height: '40px', }} fullWidth>
                  <Select
                    labelId="demo-simple-select-label"
                    id="demo-simple-select"
                    value={Priorty}
                    onChange={handleChange}
                    sx={{ borderRadius: '20px', border: 'unset', height: '40px' }}
                  >
            ...
            <Box sx={{ width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', mt: 3 }} >
              ...
              <Box sx={{
                ...
                <Button onClick={() => setCompleted('yes')} variant="contained" sx={{
                  textTransform: 'capitalize', borderRadius: '30px', fontSize: '16px', px: 4, py: 1, borderColor: '#A2A2A2', display: 'flex', justifyContent: 'center', alignItems: 'center', width: {
                    sm: '50%',
                    xs: '100%'
                  }, fontFamily: 'Ubuntu', mr: {
                    sm: 1
                  }, boxShadow: 'none'
                }} ><DoneOutlineIcon sx={{ mr: 1, fontSize: '18px' }} />Yes</Button>
                <Button onClick={() => setCompleted('no')} variant="contained" sx={{
                  textTransform: 'capitalize', borderRadius: '30px', fontSize: '16px', px: 4, py: 1, borderColor: '#A2A2A2', display: 'flex', justifyContent: 'center', alignItems: 'center', width: {
                    sm: '50%',
                    xs: '100%'
                  }, fontFamily: 'Ubuntu', ml: {
                    sm: 1
                  }, boxShadow: 'none', mt: {
                    sm: 0,
                    xs: 2
                  }
                }} ><ClearIcon sx={{ mr: 1, fontSize: '18px' }} />No</Button>
              </Box>
              <Box sx={{ width: '100%', display: 'flex', justifyContent: 'start', alignItems: 'center' }} >
                <Typography variant="h6" sx={Validate ? { fontSize: '14px', lineHeight: '20px', color: 'red', textTransform: 'capitalize', fontWeight: 400, ml: 2, mt: 1, fontFamily: 'Ubuntu', } : { display: 'none' }} gutterBottom component="div">
                  Choose one
            ...
            <Box sx={{ width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', mt: 3 }} >
              ...
              <Box sx={{ width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center' }} >
                <textarea rows="8" required value={TaskDes} onChange={(e) => setTaskDes(e.target.value.toLowerCase())} type="email" style={{ width: '100%', height: '100%', outline: 'none', border: 'unset', fontSize: '16px', lineHeight: '24px', padding: '0px 4px', color: '#666666', borderRadius: '20px', border: '1px solid #666666', padding: '10px', resize: 'vertical' }} placeholder='Enter description here..' />
              </Box>
              <Box sx={{ width: '100%', display: 'flex', justifyContent: 'start', alignItems: 'center' }} >
                <Typography variant="h6" sx={Validate ? { fontSize: '14px', lineHeight: '20px', color: 'red', textTransform: 'capitalize', fontWeight: 400, ml: 2, mt: 1, fontFamily: 'Ubuntu', } : { display: 'none' }} gutterBottom component="div">
            ...
            <Button onClick={() => AddTask()} variant="contained" sx={{ textTransform: 'capitalize', borderRadius: '30px', fontSize: '16px', px: 4, py: 1, borderColor: '#A2A2A2', display: 'flex', justifyContent: 'center', alignItems: 'center', width: '50%', mt: 3, fontFamily: 'Ubuntu', }} ><AddCircleOutlineIcon sx={{ mr: 1 }} />Add task</Button>
          </Box>
          <Box sx={{
            width: {
              md: '60%',
              xs: '100%'
            }, px: 2, display: 'flex', justifyContent: 'center', alignItems: 'center', mt: 4, flexDirection: 'column', mb: 4
          }} >
            <Typography variant="h6" sx={{ fontSize: '32px', lineHeight: '40px', color: '#A2A2A2', textTransform: 'capitalize', mt: 2, fontFamily: 'Ubuntu', }} component="div">
              Recent added tasks
            </Typography>
            {/* <ul>
            {state.map((list) => {
